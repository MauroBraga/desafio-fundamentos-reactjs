  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      await  api.get('transactions').then(response => {
        ...
        const transactionsFormatadas = transactions.map( (transaction:Transaction)  => {
        ...
        <CardContainer>
          <Card>
            <header>
             ...
             <h1 data-testid="balance-income">{balance.income && balance.income}</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">{balance.outcome && balance.outcome}</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
            ...
            <h1 data-testid="balance-total">{balance.total && balance.total}</h1>
          </Card>
        </CardContainer>
